...
//    cout << "Put Price for 1000000 paths: " << putPrice_3 << endl;
    ...
    MCPricer mc(S,v,r,M_1);
    EuropeanCall call2(K,T);
    double callPrice2 = mc.Price(call2);
    cout << "Call Price: " << callPrice2 << endl;

    AmericanPut put2(K,T);
    double putPrice2 = tree.Price(put2);
